...
const Body = () => {
  ...
  const fetchData = async () => {
    ...
    const data = await fetch(
      "https://proxy.corsfix.com/?https://www.swiggy.com/dapi/restaurants/list/v5?lat=18.6326695&lng=73.8220565&is-seo-homepage-enabled=true&page_type=DESKTOP_WEB_LISTING"
    );
